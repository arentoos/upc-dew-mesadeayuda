...
function valida(F) {
        ...
        if( vacio(F.txtDescrip.value) == false  ) {
                alert("Introduzca DescripciÛn valida")
                return false
        } else {
               // alert("OK")
						        ...
						        <table width="418" border="1" align="center" cellpadding="0" cellspacing="0">
						              <tr>
						                <td  ><table width="479" border="1" cellpadding="0" cellspacing="0" >
						                  ...
						                  <tr>
						                    <td id="letrasTablas3">Fecha de Creaci√≥n:</td>
						                    <td colspan="3" id="letrasTablas4">${ticket.fechaCreacion}</td>
					                      </tr>
						                  <tr>
						                    <td id="letrasTablas3">Area de Atenci√≥n:</td>
						                  ...
						                  <tr>
						                    <td id="letrasTablas3">Ultima Actualizaci√≥n:</td>
